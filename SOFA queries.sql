...
(
  select ie.icustay_id
    ...
    , max(case
            when itemid = 30047 then rate / coalesce(wt.weight) -- measured in mcgmin
    ...
    , max(case
            when itemid =  30044 then rate / coalesce(wt.weight) -- measured in mcgmin
